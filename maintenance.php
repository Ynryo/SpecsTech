...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h2>&#128679; Maintenance <span class="colored-logo">du site</span> &#128679;</h2>
            <img src="/assets/svg/header-line.svg" alt="" srcset="/assets/svg/header-line.svg">
            <p>Specs-Tech est actuellement en maintenance. Nous faisons tout notre possible pour réouvrir au plus vite.<br>Nous vous remercions pour votre patience.</p>
        </div>
    </section>
