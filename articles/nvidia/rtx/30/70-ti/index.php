...
<head>
    <title>NVIDIA GeForce RTX 3070 Ti | Specs-Tech</title>
    <meta charset="utf-8">
    ...
    <meta property="og:title" content="NVIDIA GeForce RTX 3070 Ti | Specs-Tech" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://specstech.fr/nvidia/rtx/30/70-ti/" />
    <meta property="og:description" content="Retrouvez toutes les informations techniques de vos cartes graphiques">
    <link rel="canonical" href="https://specstech.fr/nvidia/rtx/30/70-ti/">
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h2><span>NVIDIA GeForce RTX 3070 Ti</span></h2>
            <img src="/assets/svg/header-line.svg" alt="" srcset="/assets/svg/header-line.svg">
            <p>Retrouvez les informations techniques de la NVIDIA GeForce RTX 3070 Ti.</p>
        </div>
    </section>
    ...
    <section class="main product">
        <div class="specs">
            ...
            <div class="table">
                ...
                <div class="table-row">
                    ...
                    <span class="block-value">1,58 GHz</span>
                </div>
                <div class="table-row">
                    <span class="block-name">Fréquence boost</span>
                    <span class="block-value">1,77 GHz</span>
                </div>
                <div class="table-row">
                    <span class="block-name">Processeurs de flux</span>
                    <span class="block-value">6144</span>
                </div>
                <div class="table-row">
                ...
                <div class="table-row">
                    ...
                    <span class="block-value">290 W</span>
                </div>
                <div class="table-row">
            ...
            <div class="table">
                ...
                <div class="table-row">
                    ...
                    <span class="block-value">267 mm</span>
                </div>
                <div class="table-row">
        ...
        <div class="product-img">
            <img srcset="/assets/images/3d/nvidia-rtx-3070-ti.png" src="/assets/images/3d/nvidia-rtx-3070-ti.png" alt="Image de la NVIDIA GeForce RTX 3070 Ti">
        </div>
    </section>
