...
<?php include(dirname(__FILE__, 7) . '/assets/src/get_properties.php') ?>
<!DOCTYPE html>
<html>

<head>
    <?php include(dirname(__FILE__, 7) . '/assets/src/articles_head.php') ?>
    <?php include(dirname(__FILE__, 7) . '/assets/src/assets.php') ?>
</head>

<body>
    <?php include(dirname(__FILE__, 7) . '/assets/src/header.php') ?>
    ...
    <?php include(dirname(__FILE__, 7) . '/assets/src/footer.php') ?>
</body>
